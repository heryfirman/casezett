          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              <div className="absolute w-28 left-0 -top-0 hidden lg:block">
                <div className="absolute h-28 inset-x-0 bottom-0 bg-gradient-to-t from-slate-50 via-slate-50/50" />
                <picture>
              ...
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                ...
                Case.
                CaseZett allows you to protect your memories, not just your phone case.
              </p>
          ...
          <div className='mx-auto max-w-6xl px-6 lg:px-8'>
            <div className='relative flex flex-col items-center md:grid grid-cols-2 gap-40'>
              <picture>
                <img
                  src='/arrow.png'
                  className='absolute top-[35rem] md:top-1/2 -translate-y-1/2 z-10 left-1/2 -translate-x-1/2 rotate-90 md:rotate-0'
                  alt=""
                />
              </picture>
